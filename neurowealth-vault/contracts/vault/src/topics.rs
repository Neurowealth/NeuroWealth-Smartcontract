...
/// Topic for `MultisigSetEvent`, published by `set_multisig` when governance
/// migrates from a single owner key to a multi-sig contract (issue #464).
pub const TOPIC_MULTISIG_SET: Symbol = symbol_short!("msig_set");
